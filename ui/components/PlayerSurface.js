...
export function renderPlayerSurface(ctx) {
  ...
  return [
    ...
    active?.dataUrl ? `<audio controls src="${escapeHtml(active.dataUrl)}" data-testid="audio-player" data-source-id="${escapeHtml(active.id)}"></audio>` : `<div class="audio-fake-controls"><button>▶</button><div></div><time>00:00</time></div>`,
