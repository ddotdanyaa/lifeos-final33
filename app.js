...
const V34_MARKETPLACE_PACKS = [
  ...
  {
    id: "pack-capture-inbox",
    title: "Capture",
    kind: "capture",
    description: "Быстрый захват мыслей, ссылок и голоса в единую очередь разбора без потери источника.",
    entities: ["Захват", "Тег", "Очередь разбора"],
    fields: ["источник", "статус", "куда", "дедлайн разбора"],
    views: ["лента", "очередь", "канбан"],
    actions: ["быстрый ввод", "разобрать в задачу", "конвертировать в заметку"],
    ...PACK_MANIFEST_DEFAULTS
  },
  {
    id: "pack-daily-time",
    title: "Daily-Time",
    kind: "daily-time",
    description: "Фокус-сессии, блоки дня и еженедельный обзор в одной системе времени.",
    entities: ["Фокус-сессия", "Блок дня", "Еженедельный обзор"],
    fields: ["длительность", "статус", "следующий шаг", "оценка недели"],
    views: ["календарь", "таймлайн", "отчёт"],
    actions: ["начать фокус-сессию", "запланировать блок", "запустить еженедельный обзор"],
    ...PACK_MANIFEST_DEFAULTS
  },
  {
    id: "pack-money-guard",
    title: "Money",
    kind: "money",
    description: "Счета, транзакции, бюджеты и подписки с честной проверкой лимитов.",
    entities: ["Счёт", "Транзакция", "Бюджет", "Подписка"],
    fields: ["сумма", "категория", "дата", "статус"],
    views: ["дашборд", "таблица", "график"],
    actions: ["добавить транзакцию", "проверить бюджет", "проверить подписку"],
    ...PACK_MANIFEST_DEFAULTS
  },
  {
    id: "pack-food-health",
    title: "Food-Health",
    kind: "food-health",
    description: "Приёмы пищи, тренировки, анализы и приём витаминов в одном дневнике здоровья.",
    entities: ["Приём пищи", "Тренировка", "Анализ", "Витамин"],
    fields: ["дата", "показатель", "норма", "статус"],
    views: ["дневник", "график", "таблица"],
    actions: ["записать приём пищи", "записать тренировку", "добавить анализ"],
    ...PACK_MANIFEST_DEFAULTS
  },
  {
    id: "pack-travel-planner",
    title: "Travel",
    kind: "travel",
    description: "Поездки, списки вещей, брони и документы без риска забыть что-то важное.",
    entities: ["Поездка", "Список вещей", "Бронирование", "Документ поездки"],
    fields: ["даты", "статус", "категория", "место"],
    views: ["чеклист", "таймлайн", "карточки"],
    actions: ["создать поездку", "добавить в список вещей", "проверить документы"],
    ...PACK_MANIFEST_DEFAULTS
  },
  {
    id: "pack-builder-ai",
    title: "Builder-AI",
    kind: "builder-ai",
    description: "Промпты, агенты, автоматизации и шаблоны для персональной сборки без запуска чужого кода.",
    entities: ["Промпт", "Агент", "Автоматизация", "Шаблон"],
    fields: ["статус", "модель", "триггер", "результат"],
    views: ["список", "история dry-run", "граф"],
    actions: ["создать промпт", "запустить dry-run", "сохранить шаблон"],
    ...PACK_MANIFEST_DEFAULTS
  }
];
