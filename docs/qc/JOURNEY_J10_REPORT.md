# Journey J10 - Knowledge and second brain

status: PASS

## What User Sees
Idea capture becomes a source-backed knowledge artifact with project/next-action proposals, related notes and graph/control trace.
