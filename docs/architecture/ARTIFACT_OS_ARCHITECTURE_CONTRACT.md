...
- `artifact-os-architecture.mjs` owns `ARTIFACT_SCHEMA_VERSION = 3`, the v34 collection registry, workspace contracts, module boundaries, state adapters and invariants.
